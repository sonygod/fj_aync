...
JsMain.main = function() {
	...
	JsMain.cnx = haxe.remoting.ExternalConnection.flashConnect("default","myFlashObject",ctx);
}
JsMain.run = function() {
	JsMain.cnx.resolve("FlashMain").resolve("foo").call([1,2]);
}
JsMain.prototype = {
	foo2: function(obj) {
